...
_Constructional website contracts for Stages 1–12 live under [`website/`](./website/) (Stage 12: access modes/firewall, Nginx edge routing, env schema, diagnostics/triage, announcements, DNS client onboarding, host port binding). Prefer implementing those contracts over authoring parallel suggestion markdown._
