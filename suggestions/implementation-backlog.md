...
- **Website markdown publishing plan**: [`website-markdown-publishing-system.md`](./website-markdown-publishing-system.md) documents the canonical website page set, suggestion template, frontmatter schema, workflow, and reuse-first guardrails. Publishing those pages into a selected docs framework is still open.
...
7. **Markdown style lint** — markdownlint on `docs/`, root policy files, and website-published suggestion pages with a narrow rule set plus frontmatter checks.
