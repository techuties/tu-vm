...
- **Canonical website suggestion model**: [`website-markdown-publishing-system.md`](./website-markdown-publishing-system.md) consolidates historical community website ideas into a markdown-first publishing, schema, governance, and tooling recommendation.
...
7. **Markdown suggestion validation** — markdownlint plus a narrow frontmatter/schema check for `suggestions/` and future website community pages.
