...
This recommendation is a consolidation point for recurring historical suggestions. It does not replace the existing GitHub issue and PR workflow; it turns accepted or high-value community knowledge into durable website content.
...
2. Keep GitHub Issues, PRs, `CONTRIBUTING.md`, and `CHANGELOG.md` as the source workflow for community input.
...
1. Add `scripts/docs-check.sh` for markdown/link/frontmatter checks.
