...
3. [Website Markdown Publishing System](./website-markdown-publishing-system.md)
   Defines the reusable markdown page set, frontmatter schema, status lifecycle, and automation hooks for a community suggestions website.
...
- Markdown suggestion frontmatter validation and generated status indexes
