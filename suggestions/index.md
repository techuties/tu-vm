...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 23 covers Nginx snippet configs, MinIO versioning/ILM, read-only proxy rootfs, Postgres GUCs/pooling, Qdrant HNSW/quantization, host timezone/NTP, and inter-service network isolation.
