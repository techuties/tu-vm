...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 24 covers unused Nginx worker env keys, Redis ACL users, MinIO SSE/KMS, host sysctl knobs, Compose `depends_on` health conditions, backup archive encryption, and unused `HEALTH_CHECK_*` intervals.
