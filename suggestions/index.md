...
3. [Website Markdown Publishing System](./website-markdown-publishing-system.md) - Defines the markdown page tree, frontmatter schema, generated indexes, and docs checks for community suggestions.

4. [Day-to-Day Tooling Framework](./day-to-day-tooling.md) - Covers operational tooling, automation, quality gates, and contributor productivity.
