...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 25 covers Compose stop grace, tini PID 1, non-root users, processor poll energy, MCP `pids_limit`, per-container `mem_swappiness`, and an honest Tika healthcheck.
