...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 21 covers Nginx Docker-DNS upstreams, platform Redis durability, helper uploader modules, multi-arch image policy, Podman/rootless path, AppArmor/seccomp profiles, and restic/borg backup backends.
