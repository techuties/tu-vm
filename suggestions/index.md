...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 31 covers n8n encryption-key honesty, Open WebUI `WEBUI_URL` and official env hygiene, MinIO public URL interpolation, helper status-probe DNS, leftover timezone literals, and Qdrant API key.
