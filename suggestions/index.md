...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 18 covers Compose IPAM, resource budgets, MCP sandboxes, quickstart, backup/restore, helper control-auth, and container hardening.
