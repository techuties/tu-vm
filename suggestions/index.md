...
1. [Publishable website pages](./website/index.md)
   Canonical constructional contracts for a future static docs site. Stage 26 covers Chromium `shm_size`, n8n-mcp digest pins, MCP Tier-2 restart honesty, Tika/MinIO resource limits, processor tmpfs with status share, datastore `ulimits.nofile`, and OOM score order.
