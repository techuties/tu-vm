...
**Stage 9** (current) adds product-surface and day-to-day community contracts that remained open after Stages 1–8 (PRs #27–#34):

- Privacy-preserving usage analytics and recommendations
- Ollama / local model catalog contribution
...
- Dashboard release highlights (“What is new”)

Stages 1–8 sibling pages are expected from open PRs #27–#34; merge hubs using the Stage 4 `stage-merge-playbook.md` (extend merge order through Stage 9) rather than rewriting those contracts here.
