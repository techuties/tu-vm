...
Canonical constructional contracts for a future static docs site live in [`website/`](./website/index.md) (Stage 25 on this branch). Stages 1–24 remain on open sibling PRs (#27–#50) and should be merged as siblings, not rewritten.
