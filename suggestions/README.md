...
Canonical constructional contracts for a future static docs site live in [`website/`](./website/index.md) (Stage 27 on this branch). Stages 1–26 remain on open sibling PRs (#27–#52) and should be merged as siblings, not rewritten.
