...
Canonical constructional contracts for a future static docs site live in [`website/`](./website/index.md) (Stage 31 on this branch). Stages 1–30 remain on open sibling PRs (#27–#56) and should be merged as siblings, not rewritten.
