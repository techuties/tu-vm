...
For the canonical metadata schema, status model, and generated-index workflow, see [`website-markdown-publishing-system.md`](./website-markdown-publishing-system.md).
